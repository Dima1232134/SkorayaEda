...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220319_skorayaeda_201f9b1a5cd2f2aa8951_20220319193057_archive.zip';
	const ARCHIVE_SIZE		 = '193266391';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '201f9b1-19193057';
    const SECONDARY_PACKAGE_HASH = 'c14546e-19193057';
	const VERSION			 = '1.4.4';
